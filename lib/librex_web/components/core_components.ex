defmodule LibrexWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: LibrexWeb.Gettext
  ...
  def header(assigns) do
    ...
    <header class={[
      ...
      <div class="flex-none join">{render_slot(@actions)}</div>
    </header>
    """
  end
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LibrexWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LibrexWeb.Gettext, "errors", msg, opts)
    end
  end
